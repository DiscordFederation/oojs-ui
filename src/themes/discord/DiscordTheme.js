 ...
 * @constructor
 */
OO.ui.DiscordTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.DiscordTheme.parent.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.DiscordTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.DiscordTheme.prototype.getElementClasses = function ( element ) {
	// Parent method
	var variant, isFramed, isActive, isToolOrGroup,
		...
		// Parent method
		classes = OO.ui.DiscordTheme.parent.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.DiscordTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.DiscordTheme();
